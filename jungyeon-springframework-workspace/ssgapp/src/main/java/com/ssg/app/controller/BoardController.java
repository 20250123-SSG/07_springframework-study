...
public class BoardController {
    ...
    @GetMapping("/list.page")     // 메뉴클릭시 : /board/list.page   |  페이징바클릭시 : /board/list.page?page=x
    ...
    public void boardDetailPage(int no, Model model){
        ...
        model.addAttribute("board", map.get("board")); // ${board.boardTitle} ..
        model.addAttribute("list", map.get("list"));   // ${list} => List<AttachDto>
    }
