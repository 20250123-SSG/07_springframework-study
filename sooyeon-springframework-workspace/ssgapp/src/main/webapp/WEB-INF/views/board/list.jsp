...
<head>
  <title>Title</title>
  <style>
    #boardList th, #boardList td:not(:nth-child(2)) {
      text-align: center;
    }
...
<div class="container p-3">
  ...
  <section class="row m-3" style="min-height: 500px">
    ...
    <div class="container border p-5 m-4 rounded">
      ...
      <c:if test="${not empty loginUser}"> <!--session에 들어가있어 바로 꺼내 사용 가능-->
      ...
      <ul id="paging_area" class="pagination d-flex justify-content-center">
        <li class="page-item ${nowPage == 1 ? 'disabled' : ''}">
          <a class="page-link" href="${contextPath}/board/list.page?page=${nowPage-1}">Previous</a>
        </li>
        ...
        <li class="page-item ${nowPage == totalPage ? 'disabled' : ''}">
          <a class="page-link" href="${contextPath}/board/list.page?page=${nowPage+1}">Next</a>
        </li>
      </ul>
