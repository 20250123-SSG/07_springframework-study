  ...
  <div class="col-4 d-flex justify-content-center align-items-center">
    ...
    <a href="#" data-toggle="modal" data-target="#loginModal">로그인</a>
      ...
      <c:otherwise>
        <!-- case2. 로그인후 -->
        <div>
              <img class="profile-img" src="${contextPath}${loginUser.profileURL}" default="/resources/images/defaultProfile.png">&nbsp;
...
<nav class="navbar m-3 navbar-expand-sm bg-dark navbar-dark d-flex justify-content-center">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="${contextPath}">공지사항</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="게시판목록페이지요청url">일반게시판</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="${contextPath}">사진게시판</a>
    </li>
  </ul>
</nav>
