  ...
  <div class="container p-3">
    ...
    <section class="row m-3" style="min-height: 500px">
      ...
      <div class="container border p-5 m-4 rounded">
        ...
        <div align="center">
          <img id="profileImg"
               src="${contextPath}${loginUser.profileURL}" default="/resources/images/defaultProfile.png" onclick="document.getElementById('profileImgFile').click();">
        ...
        <script>
          document.getElementById('profileImgFile').addEventListener('change', evt => {
              ...
              fileInput.files.[0]: 선택된 첫 번재 파일 객체
              */
              ...
              if(fileInput.files.length != 0){
                  ...
                  fetch('${contextPath}/user/modifyProfile.do', {
                      method: 'POST',
                      body: formData // FormData객체 전송시 기본적으로 multipart/form-data
                  })
