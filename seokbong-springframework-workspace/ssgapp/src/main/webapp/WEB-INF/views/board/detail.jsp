...
<div class="container p-3">
  ...
  <section class="row m-3" style="min-height: 500px">
    ...
    <div class="container border p-5 m-4 rounded">
      ...
      <a class="btn btn-secondary" style="float:right" href="목록페이지요청url">목록으로</a>
      <br><br>

      <table align="center" class="table">
        <tr>
          <th width="120">${board.boardTitle}</th>
          <td colspan="3">게시판 제목자리여라 ..</td>
        </tr>
        <tr>
          <th>작성자</th>
          <td width="400">${board.boarWriter}</td>
          <th width="120">작성일</th>
          <td>2020-03-20</td>
        </tr>
        <tr>
          ...
          <td colspan="3">
            ...
            <c:choose>
              ...
              <c:otherwise>
                <c:forEach var="attach" items="${list}"></c:forEach>
                  <a href="${contextPath}${attach.filePath}/${attach.filesystem}" download="">${attach.orifinalNane}</a>
              </c:otherwise>
            </c:choose>
